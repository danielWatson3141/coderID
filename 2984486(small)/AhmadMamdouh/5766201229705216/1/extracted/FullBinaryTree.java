...
public class FullBinaryTree {
	...
	static int go3(P[] values, int index, int taken, int len) {
		...
		return dp[index][taken] = Math.min(way1, way2);
	}
	static Integer[][] dp = new Integer[1005][3];
