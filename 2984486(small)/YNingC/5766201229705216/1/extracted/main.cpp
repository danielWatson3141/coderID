...
int main(int argc, const char * argv[])
{
	int T;
	int N;
    freopen("/Users/YNingC/Documents/CodeForces/GCJ1AB/GCJ1AB/B-large.in","r",stdin);
    freopen("/Users/YNingC/Documents/CodeForces/GCJ1AB/GCJ1AB/B-large.out","w",stdout);
	cin>>T;
