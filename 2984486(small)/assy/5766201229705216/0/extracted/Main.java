...
//	Scanner sc = new Scanner(in);
	...
	void run() {
		try {
			sc = new Scanner(new File("/Users/ryo/Documents/procon/codejam2014r1a/B-small-attempt0.in"));
			pw = new PrintWriter(new BufferedWriter(new FileWriter(new File("/Users/ryo/Documents/procon/codejam2014r1a/B-small-attempt0.out"))));
