...
import codejam.util.Printer;
import codejam.util.Reader;
...
public class ProblemA {
    ...
    public static void main(String[] args) {
        Scanner sc = Reader.getScanner("A/A-small-attempt0.in");
        Printer out = new Printer("A/A-small-attempt0.out");
