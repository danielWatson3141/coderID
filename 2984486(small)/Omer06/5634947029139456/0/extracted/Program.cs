...
namespace Problem1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] lines = System.IO.File.ReadAllLines(@"C:\Users\Omer\Documents\Visual Studio 2013\Projects\Round1A GoogleCodeJam\Problem1\Input\A-small-attempt0.in"); int indexForLines = 0;
