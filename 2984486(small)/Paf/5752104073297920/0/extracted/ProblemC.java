...
public class ProblemC {
	...
	public class Case {
		...
		public void solve(int caseIndex) {
			...
			double center = sum / total / ((numbers.length - 1) / 2.0);

//			println("*************************: "+Math.abs(center - 1.0));
			boolean good = Math.abs(center - 1.0) < 0.01;

			println("Case #" + (caseIndex + 1) + ": " + (good ? "GOOD" : "BAD"));
		}
