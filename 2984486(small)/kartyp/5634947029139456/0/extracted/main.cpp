...
int flip(bitset <10> myBit,bitset <10> myBitCopy, int pos,vector <string> vecyou)
{   
    int i,j,one=1,two=1;
    anoVec2.clear();
...
int main(int argc, char** argv) 
{
    ...
    ifstream input_data("A-small-attempt2.in");
    ofstream outputFile("outter.txt");
    int i,j,t,k,answer;
    //input_data.open;
    input_data>>t;
    for(i=0;i<t;i++)
