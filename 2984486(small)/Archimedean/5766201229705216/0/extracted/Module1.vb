...
Module Module1
    ...
    End Sub
    Function digsum(ByVal x As Long) As Integer
    ...
    End Sub
    Sub R2Alg_2014(ByVal InFile As String, ByVal OutFile As String)
        ...
        For nc = 1 To numC
            ...
            For i = 0 To N - 1
                ...
                ' determine mask to match flowrq(0) to switch i

                mask = flowrq(0) Xor flowin(i)

               

                If digsum(mask) < bestswp Then

                    For j = 0 To N - 1

                        flowtp(j) = flowin(j) Xor mask
                    ...
                    If flag Then bestswp = digsum(mask)
    ...
    Sub R2B_2014(ByVal InFile As String, ByVal OutFile As String)
        ...
        Dim i As Integer, j As Integer, k As Integer, v As Integer, w As Integer
        Dim bestwt As Integer
        Dim hvy1 As Integer, hvy2 As Integer
        Dim totcost As Integer, cost As Integer
        ...
        For nc = 1 To numC
            ...
            For i = 1 To N
                ...
                If deg(i) >= 2 Then
                    ...
                    Do
                        ...
                        clevel += 1
                        For j = 1 To N
                            If level(j) = clevel - 1 Then

                                For k = 1 To deg(j)
                                    If level(adj(j, k)) = 0 Then
                                        flag = False
                                        level(adj(j, k)) = clevel
                                        pred(adj(j, k)) = j
                                    End If
                                Next k
                            End If
                    ...
                    ' clevel -= 1 ' this is now the bottommost level

                    For j = 1 To N
                        wt(j) = 1
                    Next j

                    For k = clevel To 2 Step -1
                        For j = 1 To N
                            If level(j) = k Then
                                wt(pred(j)) += wt(j)
                            End If
                    ...
                    For k = clevel To 1 Step -1
                        ...
                        For v = 1 To N
                            ...
                            If level(v) = k Then
                                ...
                                If k <> 1 And (deg(v) = 1 Or deg(v) = 3) Then ' great!  Do nothing!

                                ElseIf k <> 1 And deg(v) = 2 Then ' must cut everything below
                                ...
                                Else ' keep two "heaviest" descendants, cut rest
                                    ...
                                    For j = 1 To deg(v)
                                        ...
                                        w = adj(v, j)
                                        If pred(w) = v Then ' descendant
                                            If wt(w) >= hvy1 Then
                                                hvy2 = hvy1
                                                id2 = id1
                                                hvy1 = wt(w)
                                                id1 = w
                                            ElseIf wt(w) >= hvy2 Then
                                                hvy2 = wt(w)
                                                id2 = w
                                            End If
                                        End If
                    ...
                    ' Debug.Print(i & " " & totcost)

                    If totcost < bestwt Then
                        bestwt = totcost
                    End If
            ...
            outf.WriteLine("Case #" & CStr(nc) & ": " & CStr(bestwt))
    ...
    Sub Main()
        ...
        InFile = "C:\Documents and Settings\dreyer\Desktop\B-small-attempt1.in"
        OutFile = "C:\Documents and Settings\dreyer\Desktop\B-small-attempt1.out"

        'InFile = "C:\Documents and Settings\dreyer\Desktop\A-large.in"
        'OutFile = "C:\Documents and Settings\dreyer\Desktop\A-large.out"

        R2B_2014(InFile, OutFile)
