...
#define SIZE_N 155
#define SIZE_L 45
char supply[SIZE_N][SIZE_L];
char need[SIZE_N][SIZE_L];
char copy_of_supply[SIZE_N][SIZE_L];

int num_of_1_in_supply[SIZE_L];
int num_of_1_in_need[SIZE_L];

void as_sort(char target[SIZE_N][SIZE_L], int num, int size)
{
