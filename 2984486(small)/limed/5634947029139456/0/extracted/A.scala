...
object A extends App {
  ...
  Console.setIn(new java.io.BufferedInputStream(new java.io.FileInputStream("A/A-small-attempt0.in")))
  Console.setOut(new java.io.BufferedOutputStream(new java.io.FileOutputStream("A/A-small.out")))
