...
public class ProblemA {
    ...
    public static void main(String[] args) throws Exception {
        Scanner sc = new Scanner(new FileReader("/Users/hadoop/codejam/A-large.in.txt"));
        PrintWriter pw = new PrintWriter(new FileWriter("/Users/hadoop/codejam/problemALarge.txt"));
